...
class Config(object):
    # pyro client config
    API_ID = os.environ.get("API_ID", "21868557")  # ⚠️ Required
    API_HASH = os.environ.get("API_HASH", "91668a524679e0f0aa79faca1bdb1ca1")  # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7732017947:AAF6VuNJ_DwukKOxgFhY4pOefL_PYycPlTE")  # ⚠️ Required
    ...
    ADMIN = [int(admin) if id_pattern.search(
        admin) else admin for admin in os.environ.get('ADMIN', '6473376800').split()]  # ⚠️ Required
    
    FORCE_SUB = os.environ.get("FORCE_SUB", "1002370994255") # ⚠️ Required Username without @
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "1002723792584"))  # ⚠️ Required
